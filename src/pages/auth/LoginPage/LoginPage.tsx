      ...
      <ScrollView nestedScrollEnabled={true}>
        <View style={styles.view}>
          <View style={styles.welcomeText}>
            <Text style={globalStyles.headText}>{I18N.t('hello').toUpperCase()}</Text>
            <Text style={globalStyles.bodyText}>{I18N.t('loginBody')}</Text>
          </View>
          ...
          <Card containerStyle={globalStyles.card}>
            <View>
              ...
              <Text
                ...
                onPress={() =>
                  navigation.navigate('ForgetPasswordAndActivation', {
                    type: 'ForgetPassword',
                  })
                }>
