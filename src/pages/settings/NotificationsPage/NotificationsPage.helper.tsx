...
/**
 * The function returns the view of reservation entity
 * @param param0 : EntityProps
 * @returns View
 */
export function getEntityLabel({item, navigation, colors, rerender}: EntityProps) {
      ...
      <TouchableOpacity
        ...
        <View style={styles.labelTextsBox}>
          <View style={styles.halfBox}>
            ...
            <Text style={[globalStyles.labelSmaller, {fontWeight: item.read ? 'normal' : 'bold'}]}>
