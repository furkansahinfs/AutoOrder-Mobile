...
import {ActivityIndicator, BackButton, Button} from '../../../components';
import {I18N} from '../../../locales';
import {useTheme} from '../../../theme';
import styles from './NotificationsPage.styles';
import {getEntityLabel} from './NotificationsPage.helper';
      ...
      <View style={[styles.view, {backgroundColor: colors.background}]}>
        <View style={styles.headerView}>
          ...
          <View style={styles.textView}>
            <Text style={[globalStyles.bodyText, {color: 'white'}]}>{I18N.t('notifications')}</Text>
          </View>
        </View>
        <FlatList
